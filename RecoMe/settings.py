...
if DEPLOY:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'recome',                      # Or path to database file if using sqlite3.
...
TEMPLATE_DIRS = (
    ...
    os.path.join(BASE_DIR, '../rakuten/templates'),
    os.path.join(BASE_DIR, '../isreport/templates'),
